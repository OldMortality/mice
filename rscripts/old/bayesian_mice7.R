...
## sex does not matter, so now we are going to run jags again with
## the model without sex
## you get some warnings now for ununused parameters
##
samples <-runjags(mouseModelA)
